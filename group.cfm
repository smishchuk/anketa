...
<cfquery name="qQuestions" datasource="#request.DS#">
select q.title, q.question_id, q.enumeration_id, a.choice_id from question q 
...
<cfoutput query="qChoice">
	...
	<td width="12%" align="center">#choice#</td>
	</cfoutput>
</tr>
...
<cfoutput query="qQuestions">
	...
	<td class="subquest">#qQuestions.title#
...
<td class="subquest" style="vertical-align:top;">
<i>Другое:</i>&nbsp;&nbsp;&nbsp;
<textarea  cols="90" rows="2" name="text_other" <!--- onkeydown="addField(#cnt#)" ---> style="font-size:100%"
...
<div align="center"><b>Пожалуйста, выберите один или более критериев в вопросе 1</b></div>
